...
srun python -m dsrnngan.tfrecords_generator --fcst-data-source ifs --obs-data-source imerg --years 2016 2017 --log-precip --fcst-norm --img-size 200 --img-chunk-width 200 --scaling-factor 1 
