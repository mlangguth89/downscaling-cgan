...
srun python -m dsrnngan.main --eval-short --restart --num-samples 320000 --records-folder /user/work/uz22147/tfrecords/70882e9ca925335d --training-weights 0.25 0.25 0.25 0.25
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
