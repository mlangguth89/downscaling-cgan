...
srun python -m dsrnngan.main --no-train --eval-model-numbers 262400 --save-generated-samples --records-folder /user/work/uz22147/tfrecords/5c577a485fbd1a72 --num-images 4000 --ensemble-size 20 --val-ym-start 201806 --val-ym-end 201905
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
