...
srun python -m dsrnngan.main --evaluate --no-train --model-numbers 275200 --save-generated-samples --records-folder /user/work/uz22147/tfrecords/f6998afe16c9f955 --num-images 4000 --ensemble-size 10 --val-ym-start 201806 --val-ym-end 201905
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
