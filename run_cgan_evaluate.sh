...
srun python -m dsrnngan.main --evaluate --model-numbers 160000 --no-train --records-folder /user/work/uz22147/tfrecords/d34d309eb0e00b04 --plot-ranks --num-images 1000 --ensemble-size 50 --val-ym-start 201806 --val-ym-end 201905
dt=$(date '+%d/%m/%Y %H:%M:%S');
echo "$dt"
