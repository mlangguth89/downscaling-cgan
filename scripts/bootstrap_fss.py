...
window_sizes = [1,100,200,300,400,500]
...
for n, thr in enumerate(hourly_thresholds):
    ...
    for ws in window_sizes:
        ...
        bootstrap_results_cgan_dict[quantile_thresholds[n]][ws] = bootstrap_metric_function(metric_func=calculate_fss, obs_array=truth_array, fcst_array=cgan_corrected, n_bootstrap_samples=args.n_bootstrap_samples, time_resample=True)
